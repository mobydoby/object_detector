...
if __name__ == '__main__':
    # Example usage.
    data_train = HW6Dataset('./data_small/train', './data_small/train.json')
    data_valid = HW6Dataset('./data_small/valid', './data_small/valid.json')
    data_test = HW6DatasetTest('./data_small/test', './data_small/test.json')
